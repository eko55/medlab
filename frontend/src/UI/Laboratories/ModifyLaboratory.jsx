  ...
  return (
    <>
      <div className="main-container CreateLaboratory">
        <h1>Edit laboratory information:</h1>
        <form>
        <div className="form-group">
          <label htmlFor="exampleFormControlInput1">Enter lab id:</label>
          <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="lab id" value={labId} onChange={handleLabIdInputChange} />
        </div>
        <div className="form-group">
...
export default ModifyLaboratory;
