...
const ModifyLabService = () => {
  ...
  const handleLabTestIdInputChange = (event) => {
  ...
  return (
    <>
      <div className="main-container">
        <h1>Edit laboratory service information:</h1>
        <form>
          <div className="form-group">
            <label htmlFor="exampleFormControlInput1">Service id:</label>
            <input
              type="text"
              ...
              value={labTestId}
              onChange={handleLabTestIdInputChange}
            />
          </div>
          <div className="form-group">
        ...
        <button onClick={() => editLabService()}>Submit</button>
...
export default ModifyLabService;
